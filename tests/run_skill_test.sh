...
cp "$PROJECT_ROOT/plugins/buildclaw/skills/build/SKILL.md" "$TEMP_SKILLS/build/SKILL.md"
cp "$PROJECT_ROOT/plugins/buildclaw/skills/audit/SKILL.md" "$TEMP_SKILLS/audit/SKILL.md"
cp "$PROJECT_ROOT/plugins/buildclaw/skills/test/SKILL.md"  "$TEMP_SKILLS/test/SKILL.md"
